...
const requiredFiles = [
  ...
  'docs/current-go-zeabur-release-readiness.md',
  ...
  'scripts/audit-pr-9-go-reconciliation.mjs',
  'scripts/audit-current-go-zeabur-release.mjs',
  ...
  'scripts/remove-next-api-routes.mjs',
