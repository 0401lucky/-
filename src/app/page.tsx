...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] overflow-x-hidden">
      ...
      {/* 主内容 */}
      <main className="max-w-[1200px] mx-auto px-4 sm:px-6 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-20">
          ...
          {/* 游戏中心入口 */}
          <Link href="/games" className="group relative overflow-hidden glass rounded-3xl p-8 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-500 hover:-translate-y-1 border border-white/60">
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-purple-50 to-transparent rounded-full blur-3xl -z-10 translate-x-1/3 -translate-y-1/3 group-hover:bg-purple-100 transition-colors"></div>
            
            <div className="flex flex-col h-full justify-between relative z-10">
              <div>
                <div className="w-14 h-14 bg-purple-50 rounded-2xl flex items-center justify-center mb-6 border border-purple-100 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                  <Gamepad2 className="w-7 h-7 text-purple-500" />
                </div>
                <h2 className="text-2xl font-bold text-stone-800 mb-3 group-hover:text-purple-600 transition-colors">游戏中心</h2>
                <p className="text-stone-500 leading-relaxed mb-8 text-sm">
                  玩游戏赚积分！用积分兑换抽奖机会或账户额度。
                </p>
              </div>
              <div className="flex items-center text-purple-600 font-bold group/btn">
                <span className="group-hover/btn:mr-2 transition-all">开始游戏</span>
                <ArrowRight className="w-5 h-5 ml-1 transition-transform group-hover/btn:translate-x-1" />
              </div>
            </div>
          </Link>
          ...
          {/* 抽奖入口 */}
          <Link href="/lottery" className="group relative overflow-hidden glass rounded-3xl p-8 hover:shadow-xl hover:shadow-red-500/10 transition-all duration-500 hover:-translate-y-1 border border-white/60">
          ...
          {/* 多人抽奖入口 */}
          <Link href="/raffle" className="group relative overflow-hidden glass rounded-3xl p-8 hover:shadow-xl hover:shadow-pink-500/10 transition-all duration-500 hover:-translate-y-1 border border-white/60">
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-pink-50 to-transparent rounded-full blur-3xl -z-10 translate-x-1/3 -translate-y-1/3 group-hover:bg-pink-100 transition-colors"></div>

            <div className="flex flex-col h-full justify-between relative z-10">
              <div>
                <div className="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mb-6 border border-pink-100 group-hover:scale-110 transition-transform duration-300 shadow-sm">
                  <Users className="w-7 h-7 text-pink-500" />
                </div>
                <h2 className="text-2xl font-bold text-stone-800 mb-3 group-hover:text-pink-600 transition-colors">多人抽奖</h2>
                <p className="text-stone-500 leading-relaxed mb-8 text-sm">
                  免费参与，人满开奖，奖品直充到账。
                </p>
              </div>
              <div className="flex items-center text-pink-600 font-bold group/btn">
                <span className="group-hover/btn:mr-2 transition-all">参与抽奖</span>
                <ArrowRight className="w-5 h-5 ml-1 transition-transform group-hover/btn:translate-x-1" />
              </div>
            </div>
          </Link>
