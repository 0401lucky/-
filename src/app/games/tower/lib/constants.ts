...
export const ANIM_REVEAL_DURATION = 500;
export const ANIM_SHIELD_BLOCK_DURATION = 500;
export const ANIM_BOSS_DEFEAT_DURATION = 600;
export const ANIM_TRAP_DURATION = 500;
export const ANIM_SHOP_DURATION = 600;
